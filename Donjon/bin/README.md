...
## Développeurs : Cavannac Gautier, Capron Melvin.
...
## How To : 
        * Récupérer le dépôt : > git clone git@gitlab-etu.fil.univ-lille1.fr:capron/COO.git
...
## Éléments de conception : 
        * Nous avons décidé de concentrer nos efforts sur la mise en place d'un code simple mais fonctionnel.
        De ce fait, nous avons essayé de mettre à niveau nos méthodes notamment au niveau des constructeurs pour éviter tout
