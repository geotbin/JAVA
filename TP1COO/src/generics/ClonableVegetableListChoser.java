...
public class ClonableVegetableListChoser {
	...
	public <T extends Vegetable & Cloneable> T chose(String name, List<T> genericitem) {
		System.out.println("None-0");
		for(Vegetable v : genericitem) {
			System.out.println(v.toString());
		}
		
		System.out.print("Enter value of the chosen item : ");
